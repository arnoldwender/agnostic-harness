...
- **The Sentinel 3 — "Refuse the cheap rescue."** *No silenced test, no suppression pragma,
  no "for now" hack that fakes green by weakening the very check meant to catch it.*
  **Falsifier:** *a gate passes only because a check was disabled, skipped, or loosened.*
- **The Navigator 3 — "Verify the confident answer."** *The claim you did not just check is
  the one to check — certainty is where drift hides.* → look at what the change did to
